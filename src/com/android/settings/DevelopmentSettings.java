...
public class DevelopmentSettings extends PreferenceActivity
    ...
    private static final String MOVE_ALL_APPS_PREF = "move_all_apps";
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mEnableAdb) {
            ...
            Settings.Secure.putInt(getContentResolver(), Settings.Secure.ALLOW_MOVE_ALL_APPS_EXTERNAL,
		    mMoveAllAppsPref.isChecked() ? 1 : 0);
            return true;
        }
